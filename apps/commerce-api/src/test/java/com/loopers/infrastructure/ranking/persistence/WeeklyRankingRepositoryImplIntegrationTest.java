...
@DisplayName("WeeklyRankingRepositoryImpl 통합 테스트")
class WeeklyRankingRepositoryImplIntegrationTest extends BaseIntegrationTest {
    ...
    class ReadTopRanked {
        ...
        void returnsItemsByScoreDateInDescendingOrder() {
            ...
            // act
            List<ProductRankingWeekly> rankings = weeklyRankingRepository.readTopRanked(SCORE_DATE, 0, 10);
        ...
        void returnsItemsByPage() {
            ...
            // act
            List<ProductRankingWeekly> rankings = weeklyRankingRepository.readTopRanked(SCORE_DATE, 1, 2);
    ...
    private void saveRanking(Long productId, LocalDate scoreDate, Double score) {
        weeklyRankingJpaRepository.save(ProductRankingWeekly.create(productId, scoreDate, score));
    }
}
