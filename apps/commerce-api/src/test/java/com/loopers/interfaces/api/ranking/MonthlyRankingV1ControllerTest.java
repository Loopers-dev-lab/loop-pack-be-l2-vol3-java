...
@WebMvcTest(MonthlyRankingV1Controller.class)
...
@DisplayName("MonthlyRankingV1Controller 단위 테스트")
class MonthlyRankingV1ControllerTest {

    private static final String ENDPOINT = "/api/v1/rankings/monthly";

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private MonthlyRankingFacade monthlyRankingFacade;
    ...
    class GetMonthlyRanking {
        ...
        void happyPath() throws Exception {
            ...
            when(monthlyRankingFacade.getMonthlyRanking(eq(baseDate), eq(1), eq(20)))
        ...
        void nullDatePassedToFacade() throws Exception {
            ...
            when(monthlyRankingFacade.getMonthlyRanking(isNull(), eq(1), eq(20)))
            ...
            verify(monthlyRankingFacade).getMonthlyRanking(null, 1, 20);
        }
        ...
        void pageZeroClampedToOne() throws Exception {
            // given
            LocalDate baseDate = LocalDate.of(2026, 4, 11);
            when(monthlyRankingFacade.getMonthlyRanking(any(), eq(1), anyInt()))
            ...
            verify(monthlyRankingFacade).getMonthlyRanking(any(), eq(1), anyInt());
        }
        ...
        void sizeClampedToMax() throws Exception {
            // given
            LocalDate baseDate = LocalDate.of(2026, 4, 11);
            when(monthlyRankingFacade.getMonthlyRanking(any(), anyInt(), eq(100)))
                    .thenReturn(new RankingPageResult(baseDate, 0L, List.of()));
            ...
            verify(monthlyRankingFacade).getMonthlyRanking(any(), anyInt(), eq(100));
        }
        ...
        void sizeZeroClampedToDefault() throws Exception {
            // given
            LocalDate baseDate = LocalDate.of(2026, 4, 11);
            when(monthlyRankingFacade.getMonthlyRanking(any(), anyInt(), eq(20)))
                    .thenReturn(new RankingPageResult(baseDate, 0L, List.of()));
            ...
            verify(monthlyRankingFacade).getMonthlyRanking(any(), anyInt(), eq(20));
        }
