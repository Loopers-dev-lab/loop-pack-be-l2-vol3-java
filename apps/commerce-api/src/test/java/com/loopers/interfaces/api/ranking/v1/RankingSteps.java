...
public class RankingSteps {
    ...
    private static final String MONTHLY_ENDPOINT = "/api/v1/rankings/monthly";
    ...
    public static ResponseEntity<ApiResponse<RankingDto.RankingResponse>> getMonthlyRankings(
            TestRestTemplate testRestTemplate,
            String queryParams
    ) {
        return doGet(testRestTemplate, MONTHLY_ENDPOINT, queryParams);
    }
