...
public class UserTest {
    ...
    class Create {
        ...
        @DisplayName("password가 8~16자의 영문/숫자/특수문자면 정상적으로 생성된다.")
        @Test
        void createsUser_whenPasswordIsValid() {
            // arrange
        ...
        @DisplayName("password가 16자 초과면 BAD_REQUEST 예외가 발생한다.")
        @Test
        void throwsBadRequestException_whenPasswordIsTooLong() {
            // arrange
            String password = "VeryLongPass123!!";
