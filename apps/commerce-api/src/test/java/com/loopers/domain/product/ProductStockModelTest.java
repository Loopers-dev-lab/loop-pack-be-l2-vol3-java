...
class ProductStockModelTest {
    ...
    class CreateTests {
        ...
        void create_WithValidInputs_ShouldSuccess() {
            ProductStockModel stock = ProductStockModel.create("product-001", 100);

            assertThat(stock.getProductId()).isEqualTo("product-001");
        ...
        void create_WithNegativeOnHand_ShouldThrow() {
            assertThatThrownBy(() -> ProductStockModel.create("product-001", -1))
    ...
    class StockCalculationTests {
        ...
        void canHold_WhenSufficient_ShouldReturnTrue() {
            ProductStockModel stock = ProductStockModel.create("product-001", 10);
    ...
    class UpdateOnHandTests {
        ...
        void updateOnHand_WhenNewOnHandLessThanReserved_ShouldThrow() {
            ProductStockModel stock = ProductStockModel.createWithReserved("product-001", 100, 50);
