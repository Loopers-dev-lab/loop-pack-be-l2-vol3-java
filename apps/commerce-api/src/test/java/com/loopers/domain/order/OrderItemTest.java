...
class OrderItemTest {
    ...
    class CreateTest {
        ...
        void createOrderItem() {
            OrderItem orderItem = OrderItem.of(1L, "테스트 상품", Money.of(10000L), 2);
        ...
        void createWithNullProductIdThrowsException() {
            assertThatThrownBy(() -> OrderItem.of(null, "테스트 상품", Money.of(10000L), 2))
        ...
        void createWithEmptyProductNameThrowsException() {
            assertThatThrownBy(() -> OrderItem.of(1L, "", Money.of(10000L), 2))
                    .isInstanceOf(CoreException.class);
        }
        ...
        void createWithZeroQuantityThrowsException() {
            assertThatThrownBy(() -> OrderItem.of(1L, "테스트 상품", Money.of(10000L), 0))
                    .isInstanceOf(CoreException.class)
    ...
    class TotalPriceTest {
        ...
        void calculateTotalPrice() {
            OrderItem orderItem = OrderItem.of(1L, "테스트 상품", Money.of(10000L), 3);
    ...
    class EqualityTest {
        ...
        void sameOrderItemsAreEqual() {
            OrderItem item1 = OrderItem.of(1L, "테스트 상품", Money.of(10000L), 2);
            OrderItem item2 = OrderItem.of(1L, "테스트 상품", Money.of(10000L), 2);
