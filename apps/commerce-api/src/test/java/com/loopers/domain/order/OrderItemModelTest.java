...
class OrderItemModelTest {
    ...
    private static final ProductSnapshot SNAPSHOT = new ProductSnapshot(1L, "테스트 상품", new BigDecimal("10000"));
    ...
    class Of {
        ...
        void of_withValidInputs_shouldSucceed() {
            // when
            OrderItemModel item = OrderItemModel.of(SNAPSHOT, QUANTITY, OPTION_ID);
            ...
            assertThat(item.getPriceSnapshot()).isEqualByComparingTo(SNAPSHOT.price());
        ...
        void of_withNullOptionId_shouldSucceed() {
            OrderItemModel item = OrderItemModel.of(SNAPSHOT, QUANTITY, null);
        ...
        void of_withNullSnapshot_shouldThrow() {
            assertThrows(IllegalArgumentException.class, () ->
                OrderItemModel.of(null, QUANTITY, OPTION_ID));
        }
        ...
        void of_withZeroQuantity_shouldThrow() {
            assertThrows(IllegalArgumentException.class, () ->
                OrderItemModel.of(SNAPSHOT, 0, OPTION_ID));
        }
        ...
        void of_withNegativeQuantity_shouldThrow() {
            assertThrows(IllegalArgumentException.class, () ->
                OrderItemModel.of(SNAPSHOT, -1, OPTION_ID));
        }
    }
}
