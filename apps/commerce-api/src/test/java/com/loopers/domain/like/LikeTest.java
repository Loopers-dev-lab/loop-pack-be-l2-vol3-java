...
class LikeTest {
    ...
    class Create {
        ...
        @DisplayName("올바른 정보이면, 좋아요가 생성된다.")
        @Test
        void createsLike_whenValidInfo() {
        ...
        void throwsBadRequest_whenUserIdIsNull() {
            CoreException result = assertThrows(CoreException.class, () -> new Like(null, 100L));
        ...
        void throwsBadRequest_whenProductIdIsNull() {
            CoreException result = assertThrows(CoreException.class, () -> new Like(1L, null));
            assertThat(result.getErrorType()).isEqualTo(ErrorType.BAD_REQUEST);
        }
    }
}
