...
class BrandServiceIntegrationTest {
    ...
    class 브랜드_등록 {
        ...
        void 유효한_정보로_등록하면_브랜드가_생성된다() {
            Brand result = brandService.register(BrandCommand.Register.of("나이키", "스포츠 브랜드"));
        ...
        void 이미_존재하는_브랜드명으로_등록하면_예외() {
            brandService.register(BrandCommand.Register.of("나이키", "스포츠 브랜드"));

            assertThatThrownBy(() -> brandService.register(BrandCommand.Register.of("나이키", "다른 설명")))
        ...
        void 삭제된_브랜드와_동일한_이름으로_등록하면_예외() {
            Brand brand = brandService.register(BrandCommand.Register.of("나이키", "스포츠 브랜드"));
            brand.delete();
            brandRepository.save(brand);

            assertThatThrownBy(() -> brandService.register(BrandCommand.Register.of("나이키", "새 설명")))
                    .isInstanceOf(CoreException.class)
                    .satisfies(e -> assertThat(((CoreException) e).getErrorType()).isEqualTo(ErrorType.CONFLICT))
                    .hasMessageContaining("이미 등록된 브랜드입니다");
        }
    ...
    class 브랜드_목록_조회 {
        ...
        void 조건_없이_조회하면_전체_브랜드가_최신순으로_반환된다() {
            brandService.register(BrandCommand.Register.of("나이키", "스포츠 브랜드"));
            brandService.register(BrandCommand.Register.of("아디다스", "독일 스포츠 브랜드"));
        ...
        void name_키워드로_검색하면_부분_일치하는_브랜드만_반환된다() {
            brandService.register(BrandCommand.Register.of("나이키 에어", "에어 시리즈"));
            brandService.register(BrandCommand.Register.of("나이키 조던", "조던 시리즈"));
            brandService.register(BrandCommand.Register.of("아디다스", "독일 스포츠 브랜드"));
        ...
        void 복합_조건_name과_deleted_적용_시_모두_반영된다() {
            brandService.register(BrandCommand.Register.of("나이키 에어", "에어 시리즈"));
            Brand deletedNike = brandService.register(BrandCommand.Register.of("나이키 조던", "조던 시리즈"));
            deletedNike.delete();
    ...
    class 활성_브랜드_목록_조회 {
        ...
        void 활성_브랜드만_이름_오름차순으로_반환된다() {
            brandService.register(BrandCommand.Register.of("다나이키", "스포츠 브랜드"));
            brandService.register(BrandCommand.Register.of("가아디다스", "독일 스포츠 브랜드"));
            brandService.register(BrandCommand.Register.of("나뉴발란스", "미국 스포츠 브랜드"));
