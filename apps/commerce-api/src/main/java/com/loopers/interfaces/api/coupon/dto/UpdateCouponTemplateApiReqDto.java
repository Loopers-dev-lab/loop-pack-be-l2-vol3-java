...
public record UpdateCouponTemplateApiReqDto(
    ...
    public CouponCommand.UpdateTemplate toCommand() {
        return new CouponCommand.UpdateTemplate(name, type, value, minOrderAmount, expiredAt);
    }
}
