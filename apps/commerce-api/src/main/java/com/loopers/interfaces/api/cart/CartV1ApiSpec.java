...
public interface CartV1ApiSpec {
    ...
    ApiResponse<Void> addToCart(User user, CartV1Dto.AddRequest request);
    ...
    ApiResponse<Void> updateQuantity(User user, Long cartItemId, CartV1Dto.UpdateQuantityRequest request);

    @Operation(summary = "항목 삭제", description = "장바구니에서 항목을 삭제합니다.")
    ApiResponse<Void> removeItem(User user, Long cartItemId);
}
