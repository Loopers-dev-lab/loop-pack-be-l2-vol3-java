...
class WeeklyRankingTaskletTest {
    ...
    class Execute {
        ...
        void calculatesCorrectDateRange() throws Exception {
            ...
            assertAll(
                    () -> assertThat(startCaptor.getValue()).isEqualTo(LocalDateTime.of(2026, 4, 6, 0, 0, 0)),
                    () -> assertThat(endCaptor.getValue()).isEqualTo(LocalDate.of(2026, 4, 12).atTime(java.time.LocalTime.MAX))
            );
        }
    }
}
