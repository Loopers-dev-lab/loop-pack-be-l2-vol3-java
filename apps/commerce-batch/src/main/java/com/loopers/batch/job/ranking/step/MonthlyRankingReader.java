...
@Component
public class MonthlyRankingReader implements ItemReader<ProductMetricsAggregation> {
    ...
    public MonthlyRankingReader(ProductMetricsDailyBatchRepository metricsRepository,
    ...
    private void initialize() {
        ...
        log.info("월간 메트릭 읽기: {} ~ {}", startDate, endDate);
        ...
        log.info("월간 랭킹 집계 완료: {}개 상품", result.size());
    }
}
