 ...
 * 주간 랭킹 MV 테이블 Writer.
 *
 * write() 는 청크 단위로 row 를 누적하고, afterStep() 에서 replaceWeeklyRanking() 을 1회 호출한다.
...
@Component
public class WeeklyRankingItemWriter implements ItemWriter<ProductMetricsAggregate>, StepExecutionListener {
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
        ...
        mvProductRankRepository.replaceWeeklyRanking(targetDate.minusDays(1), accumulated);
        return stepExecution.getExitStatus();
    }
}
