...
1. **전체 여정 요약** — 1~10주차 동안 다뤘던 주요 테마 및 문제점들을 간단히 돌아보기. 단순 나열이 아니라, 흐름이 어떻게 연결되었는지를 강조.
2. **가장 큰 전환점** — 내 기존의 사고방식이 바뀌었다 싶은 순간.
3. **나의 Trade-off 판단** — 실습 중 내가 내린 중요한 선택 1~2개. 왜 그 선택을 했고, 대안은 뭐였는지, 지금 다시 한다면 어떻게 할 건지.
4. **실전과의 연결** — "이건 실제 회사/서비스에서 써먹을 수 있겠다" 싶은 포인트.
