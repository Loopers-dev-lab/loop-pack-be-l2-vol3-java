...
>
> **낙관적 락(Optimistic Lock)** 또는 **비관적 락(Pessimistic Lock)** 중 각 도메인의 특성에 맞는 전략을 선택하여 적용하세요.
> Application Layer(혹은 OrderFacade)에서의 트랜잭션 경계 설계가 핵심입니다.
