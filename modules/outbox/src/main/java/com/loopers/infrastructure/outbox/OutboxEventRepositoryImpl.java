...
public class OutboxEventRepositoryImpl implements OutboxEventRepository {
    ...
    public List<OutboxEvent> findPublishCandidates(ZonedDateTime now, int limit) {
        List<OutboxEventEntity> candidates = outboxEventJpaRepository.findPublishCandidates(OutboxEventStatus.PENDING, OutboxEventStatus.FAILED, now);
    ...
    @Override
    @Transactional
    public void markAckedByEventId(UUID eventId, ZonedDateTime ackedAt) {
